// src/navigation/drawer/DrawerContentMarcador.tsx
...
export default function DrawerContentMarcador({ navigation }: DrawerContentComponentProps) {
  ...
  return (
    <DrawerContentScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('MarcadorTabs')}>

...
export default function DrawerContentAuxiliar({ navigation }: DrawerContentComponentProps) {
  ...
  return (
    <DrawerContentScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Menú Auxiliar</Text>

      <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('AuxiliarTabs')}>
        <Text style={styles.text}>Inicio</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('MapaRecorrido')}>
        <Text style={styles.text}>Mapa de Recorridos</Text>
      </TouchableOpacity>
